...
def test_identify_test_bench_shimadzu(mocker):
    ...
    test_bench = TestBench.identify_test_bench('./Data/Exemple_Shimadzu_Tract_L100_D2.csv')
    assert test_bench == 'Shimadzu'

def test_identify_test_bench_WB400kN(mocker):
    

    test_bench = TestBench.identify_test_bench('./Data/Exemple_WB400kN_Tract_L100_D2.csv')
    assert test_bench == 'WB400kN_1'

def test_identify_test_bench_WB400kN_2(mocker):
    

    test_bench = TestBench.identify_test_bench('./Data/Exemple_WB400kN_2_Tract_L100_D10.csv')
    assert test_bench == 'WB400kN_2'

def test_identify_test_bench_WB100kN(mocker):
    

    test_bench = TestBench.identify_test_bench('./Data/Exemple_WB100kN_Tract_L100_D2.csv')
    assert test_bench == 'WB100kN'
...
def test_identify_file_shimadzu(mocker):
    tb = TestBench('./Data/Exemple_MS_Shimadzu_Flex_L20_D2.csv')
    tb.test_bench = tb.identify_test_bench('./Data/Exemple_MS_Shimadzu_Flex_L20_D2.csv')
